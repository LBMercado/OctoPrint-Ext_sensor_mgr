...
class Sht30(Sensor):
    ...
    def _configure(self, config: dict):
        ...
        self.init_history_reading(
            Sht30.convert_value_type(config, 'max_readings'))
    ...
    def _read(self):
        ...
        self.bus.write_i2c_block_data(self.i2c_addr, Sht30.MEASURE_CMD, [
                                      Sht30.MEASURE_CONF_REPEAT_CMD])
        time.sleep(0.5)
        # Read data back from 0x00(00), 6 bytes
        # cTemp MSB, cTemp LSB, cTemp CRC, Humididty MSB, Humidity LSB, Humidity CRC
        data = self.bus.read_i2c_block_data(
            self.i2c_addr, Sht30.READ_CMD, Sht30.READ_BYTE_LEN)
