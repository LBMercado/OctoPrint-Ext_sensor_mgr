...
class SensorManager:
    ...
    def handle_msg(self, msg) -> Sensor:
        self._logger.debug(context="SensorManager.handle_msg: msg", ref_object=msg)
        ...
        if sensor is None:
            ...
            if constructor is None:
                self._logger.debug(context="SensorManager.handle_msg: new sensor - (1) constructor is not defined", ref_object=constructor, context_level=ContextLevel.ERROR)
                self._logger.debug(context="SensorManager.handle_msg: new sensor - (2) sensor type", ref_object=sensor_type, context_level=ContextLevel.ERROR)
        ...
        self._logger.debug(context="SensorManager.handle_msg: sensor", ref_object=sensor)
